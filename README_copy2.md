...
> **Dynamic Sample Weight**
>
> 최근 분기일수록 더 높은 가중치로 학습하도록 시간 가중치(Recency Weight)를 결합했다. Hold-out 구간(2021~2025)이 AI 반도체 수요 급증으로 학습 구간 전체의 패턴과 분포가 달라지는 것(distribution shift)에 대응하기 위함이다.
>
> ```python
